...
/**
 * this class from async http client
 */
public class CrawlerConfigHelper {
    ...
    public static class Config {
        ...
        public static final String DEFAULT_AHC_PROPERTIES = "crawler-default.properties";
        public static final String CUSTOM_AHC_PROPERTIES = "crawler.properties";
